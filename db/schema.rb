...
ActiveRecord::Schema.define(version: 20151207183716) do
  ...
  add_index "user_prices", ["product_id"], name: "index_user_prices_on_product_id", using: :btree

  add_foreign_key "items", "lists"
  add_foreign_key "user_prices", "products"
end
